...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CLm4CiJt.mjs')
  }
];
...
const components_plugin_6gv3GfFs6qijtjqL5AgMP4SwvwMf_j900fnO6jfuwGc = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  components_plugin_6gv3GfFs6qijtjqL5AgMP4SwvwMf_j900fnO6jfuwGc
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-D0jqup6m.mjs').then((m) => m.default || m)),
  error: defineAsyncComponent(() => import('./error-hfXDv44M.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ByFjZk0A.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BvhBGih7.mjs'));
